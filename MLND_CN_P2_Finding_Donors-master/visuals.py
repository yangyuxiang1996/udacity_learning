...
def feature_plot(importances, X_train, y_train):
    ...
    indices = np.argsort(importances)[::-1] # 将feature中的元素从小到大排列，反向取其索引，即按照从大到小的顺序取对应的索引
    columns = X_train.columns.values[indices[:5]] # 取前五个最重要的feature对应的名字
    values = importances[indices][:5] # 取对应的importance
